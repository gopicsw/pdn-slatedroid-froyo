...
#
# Modified by HaTaX to be n00b friendly, changed generic to pdn_slatedroid
#
function chooseproduct()
{
    if [ "x$TARGET_PRODUCT" != x ] ; then
        ...
        if [ "$TARGET_SIMULATOR" = true ] ; then
            ...
            default_value=pdn_slatedroid-eng
        fi
    fi
...
# Modified by HaTaX to be n00b friendly, changed generic to pdn_slatedroid
add_lunch_combo pdn_slatedroid-eng
...
function lunch()
{
    ...
    if [ "$1" ] ; then
        ...
        print_lunch_menu
# Modified by HaTaX to be n00b friendly, changed generic to pdn_slatedroid
        echo -n "Which would you like? [pdn_slatedroid-eng] "
